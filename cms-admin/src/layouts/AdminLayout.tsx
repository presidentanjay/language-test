...
export default function AdminLayout({
  ...
  return (
    <div className="flex min-h-screen bg-slate-50">
      ...
      {/* ── SIDEBAR ── */}
      <aside
        className={`fixed top-0 left-0 h-full z-50 w-72 bg-[#060b18] flex flex-col transition-transform duration-300 ${sidebarOpen ? "translate-x-0" : "-translate-x-full"} lg:translate-x-0 lg:sticky lg:top-0 lg:h-screen lg:z-auto`}
      >
        {/* Logo */}
        <div className="px-6 py-8 border-b border-white/5 flex items-center justify-between">
          <div className="flex items-center gap-3">
            ...
            <div>
              <div className="font-black text-white uppercase tracking-tight text-[11px] leading-tight">
                Widyatama
              </div>
              <div className="text-[9px] font-black text-blue-400 uppercase tracking-[0.15em]">
                CMS Admin
              </div>
            </div>
          </div>
