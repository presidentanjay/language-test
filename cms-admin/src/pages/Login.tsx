        ...
        <div className="min-h-screen flex">
            ...
            <div className="hidden lg:flex lg:w-1/2 bg-[#060b18] flex-col justify-between p-12 relative overflow-hidden">
                ...
                <div className="relative z-10 flex items-center gap-3">
                    ...
                    <div>
                        <div className="font-black text-white text-lg uppercase tracking-tight leading-tight">Lembaga Bahasa</div>
                        <div className="text-[10px] font-black text-blue-400 uppercase tracking-[0.2em]">CMS Admin Panel</div>
                    </div>
                </div>
                ...
                <div className="relative z-10">
                    <div className="inline-flex items-center gap-2 bg-blue-600/20 border border-blue-500/30 rounded-full px-4 py-1.5 mb-6">
                        ...
                        <span className="text-[11px] font-black text-blue-300 uppercase tracking-widest">Content Management System</span>
                    </div>
                    ...
                    <p className="text-slate-400 text-lg leading-relaxed max-w-sm">
                        Platform administrasi untuk mengelola soal, peserta, ujian, dan laporan dalam satu tempat.
                    </p>
                    ...
                    <div className="flex gap-8 mt-10">
                        {[
                            ...
                            <div key={i}>
                                ...
                                <div className="text-[10px] text-slate-500 font-bold uppercase tracking-widest mt-0.5">{s.desc}</div>
                            </div>
                        ))}
                    </div>
                </div>
            ...
            <div className="flex-1 flex items-center justify-center bg-slate-50 px-8 py-12">
                <div className="w-full max-w-md">
                    ...
                    <div className="flex items-center gap-3 mb-10 lg:hidden">
                        ...
                        <div className="font-black text-slate-900 uppercase tracking-tight">Lembaga Bahasa CMS</div>
                    </div>

                    <div className="mb-8">
                        <h2 className="text-3xl font-black text-slate-900 mb-1">Masuk ke CMS</h2>
                        <p className="text-slate-400 text-sm font-medium">Gunakan akun admin untuk mengakses panel.</p>
                    </div>
