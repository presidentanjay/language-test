      ...
      <div className="space-y-6">
        <div className="flex items-center justify-between">
          ...
          <Button
            ...
            className="flex items-center gap-2 bg-blue-600 hover:bg-blue-700 shadow-lg shadow-blue-600/20"
          >
          ...
          >
            ...
            <div className="space-y-4 border-t pt-6">
              <div className="flex items-center justify-between">
                ...
                <Button
                  ...
                  onClick={() =>
                    setFormData((prev) => ({
                      ...prev,
                      schedules: [...prev.schedules, { date: "", time: "" }],
                    }))
                  }
                  className="bg-blue-50 text-blue-600 hover:bg-blue-100 px-3 py-1 text-xs"
                >
                  + Tambah Jadwal
                </Button>
              </div>
              ...
              {formData.schedules.map((schedule, index) => (
                <div
                  key={index}
                  className="flex items-end gap-4 p-4 border border-slate-100 rounded-xl bg-slate-50 relative group"
                >
            ...
            <div className="space-y-4 border-t pt-6">
              ...
              <Input
                ...
                onChange={(e) =>
                  setFormData({ ...formData, conferenceLink: e.target.value })
                }
        ...
        <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-3">
          {loading ? (
            ...
            exams.map((exam) => (
              <div
                key={exam.id}
                className="bg-white rounded-[40px] border border-slate-100 shadow-xl shadow-slate-200/40 hover:shadow-2xl hover:shadow-blue-600/10 transition-all p-8 flex flex-col group translate-y-0 hover:-translate-y-1"
              >
                <div className="flex justify-between items-start mb-6">
                  <div className="flex flex-col gap-2">
                    <span
                      className={`w-fit text-[10px] font-black px-3 py-1 rounded-full uppercase tracking-widest ${
                        exam.category === "ept"
                    ...
                    <span className="text-xs text-slate-400 font-black tracking-widest uppercase">
                      {exam.code}
                    </span>
                  </div>
