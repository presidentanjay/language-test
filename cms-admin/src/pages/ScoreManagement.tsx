        ...
        <AdminLayout>
            <div className="space-y-6">
                <div className="flex items-center justify-between">
                    <div>
                        <h2 className="text-2xl font-black text-slate-900 tracking-tight">Manajemen Pemetaan Skor</h2>
                        <p className="text-sm font-bold text-slate-500 mt-1">
                            Atur konversi nilai mentah ke nilai skala (Scaled Score) untuk tes EPT (TOEFL)
                        </p>
                    </div>
                    <Button
                        onClick={handleSave}
                        ...
                        {loading ? (
                            ...
                            <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-5 xl:grid-cols-6 gap-4">
                                {Array.from({ length: getMaxQuestions() + 1 }, (_, i) => i).map((raw) => (
                                    <div key={raw} className="flex items-stretch border border-gray-200 rounded-lg overflow-hidden focus-within:ring-2 focus-within:ring-blue-500 focus-within:border-transparent transition-all">
