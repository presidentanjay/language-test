      ...
      <div className="space-y-6">
        <div className="flex items-center gap-4">
          <button
            ...
            className="p-2 text-slate-400 hover:text-slate-900 transition-colors bg-white rounded-xl shadow-sm"
          >
        ...
        <div className="flex justify-end">
          <Button
            ...
            className="flex items-center gap-2 bg-slate-900 shadow-xl shadow-slate-900/10"
          >
        ...
        <div className="grid gap-6">
          {loading ? (
            ...
            questions.map((q, idx) => (
              <div
                key={q.id}
                className="bg-white rounded-[40px] border border-slate-100 shadow-xl shadow-slate-200/40 p-10 group overflow-hidden relative"
              >
        ...
        >
          ...
          >
            <div className="space-y-4">
              <label className="text-xs font-black uppercase tracking-[0.2em] text-blue-600 block">
                Pertanyaan
              </label>
              <textarea
            ...
            <div className="space-y-4">
              <div className="flex justify-between items-center mb-2">
                <label className="text-xs font-black uppercase tracking-[0.2em] text-blue-600">
                  Pilihan Jawaban
                </label>
                <button
                  type="button"
