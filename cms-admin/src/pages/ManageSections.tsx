...
export default function ManageSections() {
  ...
  const handleBulkUpload = async () => {
    ...
    try {
      ...
      await api.post(`/sections/${selectedSection.id}/bulk-questions`, {
        questions,
      });
        ...
        <div className="flex items-center gap-4">
          ...
          <div>
            ...
            <p className="text-sm text-gray-500">
              Manage packages and questions for this exam.
            </p>
          </div>
        </div>
                  ...
                  <div className="flex justify-between items-start">
                    <div>
                      ...
                      <div className="mt-1 flex items-center gap-3 text-xs text-gray-500">
                        <span className="font-mono bg-slate-100 px-2 py-0.5 rounded uppercase">
                          {section.section}
                        </span>
              ...
              {audioSegments.length === 0 ? (
                ...
                <div className="space-y-2">
                  {audioSegments.map((seg) => (
                    <div
                      key={seg.id}
                      className="bg-white border border-slate-100 p-4 rounded-2xl flex flex-col gap-3 shadow-sm"
                    >
                      ...
                      <audio
                        ...
                        src={`${import.meta.env.VITE_API_BASE_URL || "http://localhost:3333"}${seg.audioUrl}`}
                      >
