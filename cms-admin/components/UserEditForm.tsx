        ...
        <form action={handleSubmit}>
            <div className="max-w-screen-sm p-5 mx-auto bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700">
                <div className="border-b-2 border-gray-200 dark:border-gray-700">
                    <h1 className="pb-1 text-2xl font-semibold text-gray-900 dark:text-white">Update User</h1>
                </div>
                <div className="mt-5">
                   ...
                   */}
                        {user.picture ? (
                            <img
                                ...
                                src={user.picture ? (user.picture.startsWith('http') ? user.picture : `/${user.picture}`) : ''}
                                alt="profile-picture"
                        ...
                        <div className="w-3/4">
                            <div className="mb-5">
                                <label className="block mb-2 text-sm font-medium text-gray-900 dark:text-white"
                                    htmlFor="picture">Change Picture</label>
                                <input
                            ...
                            <div className="mb-5">
                                <label htmlFor="npm" className="block mb-2 text-sm font-medium text-gray-900 dark:text-white">NPM</label>
                            ...
                            {/* Read-only fields */}
                            <div className="mb-5">
                                <label className="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Faculty</label>
                                <input type="text" className="bg-gray-50 cursor-not-allowed border border-gray-300 text-gray-900 text-sm rounded-lg block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:text-white"
                                    value={user.profile?.faculty || ''} disabled />
                            </div>

                            <div className="mb-5">
                                <label className="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Program Study</label>
                                <input type="text" className="bg-gray-50 cursor-not-allowed border border-gray-300 text-gray-900 text-sm rounded-lg block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:text-white"
