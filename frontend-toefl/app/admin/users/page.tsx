...
export default function AdminUsersPage() {
  ...
  const handleSave = async () => {
    ...
    try {
      ...
      setUsers((prev) =>
        prev.map((u) => (u.id === editUser!.id ? { ...u, ...res.data } : u)),
      );
      setEditUser(null);
    } catch (err: any) {
        ...
        <main className="flex-1 p-6 space-y-5">
          ...
          <div className="grid grid-cols-2 sm:grid-cols-4 gap-4">
            {[
              ...
              {
                label: "Peserta",
                val: counts.test_taker,
                icon: <UserCheck className="h-5 w-5 text-blue-600" />,
                bg: "bg-blue-50",
                active: roleFilter === "test_taker",
                filter: "test_taker",
              },
              {
                label: "Guest",
              ...
              >
                <div
                  className={`h-10 w-10 ${s.bg} rounded-xl flex items-center justify-center shrink-0`}
                >
                  {s.icon}
                </div>
                <div>
          ...
          <div className="relative">
            ...
            <input
              className="w-full bg-white border border-slate-100 rounded-2xl py-3.5 pl-11 pr-5 text-sm font-medium text-slate-900 outline-none focus:border-blue-200 focus:ring-4 focus:ring-blue-50 transition-all placeholder:text-slate-400 shadow-sm"
                  ...
                  >
                    ...
                    <div className="min-w-0">
                      <div className="flex items-center gap-2 mb-0.5">
                        ...
                        {u.id === me?.id && (
                          <span className="text-[9px] font-black bg-blue-100 text-blue-600 px-1.5 py-0.5 rounded-md shrink-0">
                            Anda
                          </span>
                        )}
                      </div>
                    ...
                    <div className="flex items-center">
                      <span
                        className={`text-[10px] font-black uppercase tracking-widest px-3 py-1.5 rounded-full ${roleBadge[u.role]?.class}`}
                      >
          ...
          >
            ...
            >
              <div className="flex items-center justify-between px-8 py-6 border-b border-slate-100">
                ...
                <button
                  onClick={() => setEditUser(null)}
                  className="h-10 w-10 bg-slate-50 hover:bg-slate-100 rounded-xl flex items-center justify-center"
                >
              ...
              <div className="px-8 py-5 border-t border-slate-100 flex justify-end gap-3">
                <button
                  onClick={() => setEditUser(null)}
                  className="px-6 py-3 text-sm font-black text-slate-500 bg-slate-50 hover:bg-slate-100 rounded-xl transition-all"
                >
                  Batal
                </button>
                <button
            ...
            >
              ...
              <div className="flex gap-3">
                <button
                  ...
                  className="flex-1 py-3 text-sm font-black bg-slate-50 hover:bg-slate-100 text-slate-600 rounded-xl"
                >
                  Batal
                </button>
                <button
