...
import { GraduationCap, Trophy, Calendar, Clock, Award, Printer, ArrowLeft, Loader2 } from "lucide-react";
        ...
        <div className="min-h-screen bg-slate-50 pb-24">
            ...
            <header className="bg-white border-b border-slate-200 h-20 px-6 flex items-center justify-between sticky top-0 z-50">
                <div className="flex items-center gap-3 cursor-pointer" onClick={() => router.push('/dashboard')}>
                    ...
                    <div className="flex flex-col">
                        <span className="font-black text-lg leading-tight tracking-tight uppercase">Riwayat Ujian</span>
                        <span className="text-[10px] font-bold text-slate-400 uppercase tracking-[0.2em]">Kembali ke Dashboard</span>
                    </div>
                </div>
            </header>
            ...
            <div className="max-w-5xl mx-auto px-6 pt-12">
                <div className="flex flex-col gap-10">
                    <div>
                        <h2 className="text-3xl font-black text-slate-900">Riwayat & Sertifikat</h2>
                        <p className="text-slate-500 mt-2">Unduh sertifikat ujian yang telah Anda selesaikan.</p>
                    </div>
                                            ...
                                            <tr key={item.id} className="hover:bg-slate-50/50 transition-colors">
                                                <td className="px-6 py-6">
                                                    <div className="flex items-center gap-3">
                                                        ...
                                                        <div>
                                                            <div className="font-bold text-slate-900 line-clamp-1">{item.exam.title}</div>
