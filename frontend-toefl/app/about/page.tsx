  ...
  const values = [
    {
      ...
      title: "Keunggulan",
      desc: "Standar kualitas tertinggi dalam setiap aspek pengajaran dan pengujian bahasa.",
    },
    {
      icon: <Globe className="h-6 w-6 text-indigo-400" />,
      title: "Globalitas",
      desc: "Orientasi internasional untuk mempersiapkan peserta menghadapi tantangan dunia.",
    },
    {
      icon: <Heart className="h-6 w-6 text-rose-400" />,
      title: "Integritas",
      desc: "Transparansi dan kepercayaan dalam setiap layanan yang kami berikan.",
    },
    {
      icon: <Lightbulb className="h-6 w-6 text-amber-400" />,
      title: "Inovasi",
      desc: "Kurikulum dan metode pengajaran yang terus berkembang sesuai kebutuhan zaman.",
    },
    {
      icon: <Users className="h-6 w-6 text-emerald-400" />,
      title: "Kolaborasi",
      desc: "Membangun ekosistem belajar yang mendukung perkembangan bersama.",
    },
    {
      icon: <BookOpen className="h-6 w-6 text-violet-400" />,
      title: "Pengetahuan",
      desc: "Berbagi ilmu dari pengajar ahli yang berdedikasi dan berpengalaman.",
    },
  ];
  ...
  const milestones = [
    {
      year: "2001",
      title: "Berdiri",
      desc: "Lembaga Bahasa Universitas Widyatama resmi didirikan.",
    },
    {
      year: "2008",
      title: "Akreditasi A",
      desc: "Meraih akreditasi grade A dari lembaga nasional.",
    },
    {
      year: "2015",
      title: "5.000 Alumni",
      desc: "Meluluskan lebih dari 5.000 peserta bersertifikasi.",
    },
    {
      year: "2023",
      title: "Platform Digital",
      desc: "Meluncurkan sistem tes berbasis digital penuh.",
    },
  ];
    ...
    <div className="min-h-screen bg-white text-slate-900 overflow-x-hidden">
      ...
      <section className="relative pt-40 pb-28 px-6 bg-white overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto text-center">
          ...
          >
            Berkomitmen memberikan standar pelatihan dan sertifikasi bahasa
            tertinggi untuk mendukung prestasi akademik dan profesional dalam
          ...
          <div className="grid lg:grid-cols-2 gap-20 items-center">
            ...
            >
              ...
              <p className="text-slate-500 text-lg leading-relaxed">
                Lembaga Bahasa Universitas Widyatama (UTama Language Center)
                telah berdiri sebagai garda terdepan dalam pengembangan
                kompetensi bahasa di lingkungan kampus dan masyarakat umum di
                Bandung.
              </p>
              <p className="text-slate-500 text-lg leading-relaxed">
              ...
              <div className="grid grid-cols-2 gap-4 pt-4">
                {[
                  ...
                  <div
                    key={i}
                    className="flex gap-4 items-start bg-slate-50 border border-slate-100 p-5 rounded-2xl"
                  >
            ...
            >
              ...
              <div className="relative z-10">
                ...
                <p className="text-slate-400 text-xl leading-relaxed">
                  Menjadi pusat pelatihan dan sertifikasi bahasa yang terkemuka,
                  inovatif, dan berdaya saing internasional pada tahun 2030.
                </p>
              </div>
            </motion.div>
        ...
        <div className="max-w-7xl mx-auto">
          ...
          >
            ...
            <p className="text-slate-400 text-lg max-w-2xl mx-auto">
              Prinsip-prinsip yang menjadi landasan kami dalam melayani setiap
              peserta.
            </p>
          </motion.div>
          ...
          >
            ...
            <div className="relative z-10">
              ...
              <p className="text-slate-400 text-xl max-w-2xl mx-auto mb-12 leading-relaxed">
                Langkah pertama menuju penguasaan bahasa internasional dimulai
                dari sini.
              </p>
          ...
          <div className="grid md:grid-cols-3 gap-16 mb-16">
            <div className="space-y-6">
              <div className="flex items-center gap-3">
                ...
                <div>
                  <span className="font-black text-lg leading-tight uppercase text-slate-900 block">
                    Lembaga Bahasa
                  </span>
