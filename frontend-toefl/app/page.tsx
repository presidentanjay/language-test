      ...
      <section className="relative pt-36 pb-24 px-6 overflow-hidden min-h-[95vh] flex items-center bg-white">
        ...
        <div className="max-w-7xl mx-auto w-full grid lg:grid-cols-2 gap-16 items-center">
          ...
          >
            ...
            >
              Pusat sertifikasi dan pelatihan bahasa terakreditasi Universitas
              Widyatama membantu Anda menembus batas global dengan persiapan
              profesional.
            </motion.p>
            ...
            >
              <div className="flex -space-x-3">
                {[1, 2, 3, 4].map((i) => (
                  <div
                    key={i}
                    className="h-10 w-10 rounded-full border-2 border-white bg-slate-100 overflow-hidden shadow-sm"
                  >
                    <img
              ...
              <div className="flex flex-col">
                <div className="flex items-center gap-1">
                  ...
                  <span className="text-xs font-black ml-1 text-slate-800">
                    4.9/5
                  </span>
                </div>
              ...
              <div className="bg-slate-50 p-8 rounded-[40px] overflow-hidden">
                ...
                <div className="mt-8 space-y-2">
                  ...
                  <p className="text-sm text-slate-500 font-medium leading-relaxed">
                    Lembaga Bahasa Universitas Widyatama menyediakan tes EPT dan
                    simulasi TOEIC berstandar internasional.
                  </p>
                </div>
              </div>
            </div>
        ...
        <div className="max-w-7xl mx-auto">
          ...
          >
            ...
            <p className="text-slate-500 text-lg max-w-2xl mx-auto">
              Dua program unggulan kami dirancang untuk membantu mahasiswa dan
              profesional membuktikan kompetensi bahasa mereka.
            </p>
          </motion.div>
        ...
        <div className="max-w-7xl mx-auto">
          ...
          >
            ...
            <p className="text-slate-400 text-lg max-w-2xl mx-auto">
              Kami memastikan setiap peserta mendapatkan pengalaman ujian yang
              adil, transparan, dan sesuai standar internasional.
            </p>
          </motion.div>
          ...
          <div className="relative z-10 grid lg:grid-cols-2 gap-16 items-center">
            <div>
              <h2 className="text-4xl md:text-6xl font-black text-white mb-8 tracking-tighter leading-[1] uppercase">
                Siap Menguji <br />
                <span className="text-blue-400">Skill Bahasa</span>
                <br />
                Anda Sekarang?
              </h2>
              <p className="text-slate-400 text-lg leading-relaxed mb-12 max-w-lg">
                Pendaftaran untuk tes periode terbaru telah dibuka. Amankan
                kursi Anda sekarang.
              </p>
          ...
          <div className="grid md:grid-cols-4 gap-16 mb-20 px-6">
            <div className="col-span-2 space-y-8">
              <div className="flex items-center gap-3">
                ...
                <div>
                  <span className="font-black text-lg leading-tight uppercase text-slate-900 tracking-tight block">
                    Lembaga Bahasa
                  </span>
              ...
              <div className="flex gap-4">
                {[Globe, Mail, Phone].map((Icon, i) => (
                  <div
                    key={i}
                    className="h-12 w-12 bg-slate-50 border border-slate-100 flex items-center justify-center rounded-2xl hover:bg-blue-600 hover:border-blue-600 transition-all cursor-pointer group"
                  >
