  ...
  return (
    <div className="min-h-screen bg-white dark:bg-[#060b18] text-slate-900 dark:text-white overflow-x-hidden">
      ...
      {/* ═══════════════════════════
                HERO — LIGHT
            ═══════════════════════════ */}
      <section className="relative pt-36 pb-24 px-6 overflow-hidden min-h-[95vh] flex items-center bg-white dark:bg-[#060b18]">
        <div className="absolute inset-0 -z-10 bg-[radial-gradient(ellipse_80%_60%_at_50%_-10%,rgba(37,99,235,0.07)_0%,transparent_70%)]" />
        <div className="absolute top-0 right-0 w-[600px] h-[600px] bg-blue-50 dark:bg-blue-900/20 rounded-full blur-[130px] opacity-50 -z-10" />
        ...
        <div className="max-w-7xl mx-auto w-full grid lg:grid-cols-2 gap-16 items-center">
          ...
          >
            ...
            >
              ...
              {t("hero.badge") || "Empowering Global Communication"}
            </motion.div>

            <motion.h1
              variants={itemVariants}
              className="text-6xl md:text-[84px] font-black text-slate-900 dark:text-white mb-8 leading-[0.95] tracking-tight"
            >
              {t("hero.title")}
            </motion.h1>
            ...
            <motion.p
              variants={itemVariants}
              className="text-slate-500 dark:text-slate-400 text-lg md:text-xl max-w-xl leading-relaxed mb-10 font-medium"
            >
              {t("hero.subtitle")}
            </motion.p>
            ...
            >
              ...
              <button
                ...
                className="w-full sm:w-auto bg-white dark:bg-[#060b18] text-slate-700 dark:text-slate-300 border border-slate-200 dark:border-white/10 font-black py-5 px-10 rounded-2xl hover:border-blue-200 hover:text-blue-600 hover:bg-blue-50 dark:bg-blue-900/20 transition-all flex items-center justify-center gap-3 active:scale-95 shadow-sm"
              >
                {t("hero.learnMore")}
              </button>
            </motion.div>
            ...
            <motion.div
              variants={itemVariants}
              className="mt-16 flex items-center gap-8 border-t border-slate-100 dark:border-white/5 pt-8 w-full"
            >
              <div className="flex -space-x-3">
                {[1, 2, 3, 4].map((i) => (
                  <div
                    key={i}
                    className="h-10 w-10 rounded-full border-2 border-white dark:border-[#060b18] bg-slate-100 dark:bg-white/10 overflow-hidden shadow-sm"
                  >
                    <img
              ...
              <div className="flex flex-col">
                <div className="flex items-center gap-1">
                  ...
                  <span className="text-xs font-black ml-1 text-slate-800 dark:text-white">
                    4.9/5
                  </span>
                </div>
          ...
          >
            <div className="p-[1px] rounded-[40px] bg-gradient-to-br from-slate-200 via-slate-100 to-transparent shadow-2xl shadow-slate-200/60 dark:shadow-none">
              <div className="bg-slate-50 dark:bg-white/5 p-8 rounded-[40px] overflow-hidden">
                <div className="bg-white dark:bg-[#060b18] border border-slate-100 dark:border-white/5 rounded-3xl p-6 shadow-md">
                  <div className="flex items-center justify-between mb-6">
                    ...
                    <div className="flex gap-2">
                      ...
                      <div className="h-2 w-8 bg-slate-100 dark:bg-white/10 rounded-full" />
                    </div>
                  </div>
                  <div className="space-y-4">
                    <div className="h-12 w-full bg-slate-50 dark:bg-white/5 border border-slate-100 dark:border-white/5 rounded-xl px-4 flex items-center justify-between">
                    ...
                    <div className="flex gap-4">
                      <div className="h-24 flex-1 bg-gradient-to-br from-blue-600 to-blue-700 rounded-2xl p-4 flex flex-col justify-between shadow-lg shadow-blue-200">
                        <div className="h-6 w-6 bg-white dark:bg-[#060b18]/20 rounded-lg flex items-center justify-center">
                      ...
                      <div className="h-24 flex-1 bg-slate-900 rounded-2xl p-4 flex flex-col justify-between shadow-lg shadow-slate-200 dark:shadow-none">
                        <div className="h-6 w-6 bg-white dark:bg-[#060b18]/10 rounded-lg flex items-center justify-center">
            ...
            <motion.div
              ...
              className="absolute -top-6 -left-6 bg-white dark:bg-[#060b18] border border-slate-100 dark:border-white/5 px-6 py-4 rounded-3xl shadow-xl shadow-slate-200/60 z-20"
            >
      ...
      <section className="py-28 px-6 bg-white dark:bg-[#060b18]">
        <div className="max-w-7xl mx-auto">
          ...
          >
            <div className="inline-flex items-center gap-2 bg-blue-50 dark:bg-blue-900/20 border border-blue-100 dark:border-blue-900/30 px-4 py-2 rounded-full text-[10px] font-black text-blue-600 mb-6 uppercase tracking-[0.2em]">
          ...
          <div className="grid md:grid-cols-2 gap-8">
            {programs.map((prog, i) => (
              <motion.div
                ...
                className="group"
              >
                <div className="relative bg-white dark:bg-[#060b18] border border-slate-100 dark:border-white/5 hover:border-blue-100 dark:hover:border-blue-900/50 dark:border-blue-900/30 rounded-[40px] p-10 transition-all duration-500 hover:shadow-2xl hover:shadow-slate-100 h-full">
                  {prog.badge && (
            ...
            {features.map((feat, i) => (
              ...
              >
                <div className="h-full bg-[#0d1526] border border-white/5 hover:border-white/10 p-12 rounded-[40px] transition-all duration-500 hover:shadow-2xl hover:shadow-blue-900/20">
                  <div className="h-16 w-16 bg-white dark:bg-[#060b18]/5 flex items-center justify-center rounded-2xl mb-10 group-hover:scale-110 group-hover:bg-blue-600/20 transition-all duration-500">
                    {feat.icon}
                  </div>
      ...
      {/* ═══════════════════════════
            ...
            ═══════════════════════════ */}
      <section className="px-6 py-32 bg-white dark:bg-[#060b18]">
            ...
            <div>
              ...
              <div className="flex flex-col sm:flex-row gap-4">
                ...
                <button
                  ...
                  className="bg-white/5 dark:bg-[#060b18]/10 border border-white/10 text-white font-black py-6 px-12 rounded-2xl hover:bg-white/10 dark:hover:bg-[#060b18]/20 transition-all active:scale-95 text-sm uppercase tracking-widest"
                >
            ...
            <div className="grid grid-cols-2 gap-4">
              {[
                ...
                <motion.div
                  ...
                  viewport={{ once: true }}
                  transition={{ delay: i * 0.1 }}
                  className="bg-white/5 dark:bg-[#060b18]/10 border border-white/5 p-8 rounded-3xl hover:bg-white/10 dark:hover:bg-[#060b18]/20 transition-colors"
                >
      ...
      {/* ═══════════════════════════
                FOOTER — LIGHT
            ═══════════════════════════ */}
      <footer className="bg-white dark:bg-[#060b18] border-t border-slate-100 dark:border-white/5 pt-24 pb-12 px-6">
        <div className="max-w-7xl mx-auto">
          <div className="grid md:grid-cols-4 gap-16 mb-20 px-6">
            <div className="col-span-2 space-y-8">
              <div className="flex items-center gap-3">
                ...
                <div>
                  <span className="font-black text-lg leading-tight uppercase text-slate-900 dark:text-white tracking-tight block">
                    Lembaga Bahasa
                  </span>
              ...
              <div className="flex gap-4">
                {[Globe, Mail, Phone].map((Icon, i) => (
                  <div
                    key={i}
                    className="h-12 w-12 bg-slate-50 dark:bg-white/5 border border-slate-100 dark:border-white/5 flex items-center justify-center rounded-2xl hover:bg-blue-600 hover:border-blue-600 transition-all cursor-pointer group"
                  >
            ...
            <div>
              <h4 className="text-xs font-black uppercase tracking-[0.25em] text-blue-600 mb-10">
                Resources
              </h4>
            ...
            <div>
              ...
              <div className="space-y-8 text-sm text-slate-500 dark:text-slate-400">
                <div className="flex gap-4">
          ...
          <div className="pt-12 border-t border-slate-100 dark:border-white/5 flex flex-col md:flex-row justify-between items-center gap-8 text-[10px] font-black text-slate-400 uppercase tracking-[0.3em]">
