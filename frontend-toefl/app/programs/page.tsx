    ...
    <div className="min-h-screen bg-white text-slate-900 overflow-x-hidden">
      ...
      <section className="relative pt-40 pb-28 px-6 bg-white overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto text-center">
          ...
          >
            Cek daftar ujian, rincian biaya, dan pelajari cara mengikuti
            sertifikasi di Lembaga Bahasa Universitas Widyatama.
          </motion.p>
        ...
        <div className="max-w-7xl mx-auto">
          ...
          >
            ...
            <p className="text-sm text-blue-800 leading-relaxed">
              <span className="font-black">Catatan:</span> Biaya yang tercantum
              dapat berubah sewaktu-waktu sesuai kebijakan Lembaga Bahasa
              Universitas Widyatama. Silakan konfirmasi kembali melalui bagian
              pendaftaran.
            </p>
          </motion.div>
        </div>
          ...
          >
            ...
            <div className="relative z-10">
              ...
              <p className="text-white/80 text-xl max-w-xl mx-auto mb-12 leading-relaxed">
                Sudah tahu tes mana yang akan diambil? Buat akun dan tentukan
                jadwal ujian Anda sekarang.
              </p>
