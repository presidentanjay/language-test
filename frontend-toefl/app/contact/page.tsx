    ...
    <div className="min-h-screen bg-white text-slate-900 overflow-x-hidden">
      ...
      <section className="relative pt-40 pb-28 px-6 bg-white overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto text-center">
          ...
          >
            Tim Lembaga Bahasa siap memberikan informasi yang Anda butuhkan
            seputar pelatihan dan sertifikasi bahasa.
          </motion.p>
        </div>
      </section>
              ...
              <div className="bg-slate-50 border border-slate-100 p-10 rounded-[40px] flex-1">
                ...
                <div className="space-y-2">
                  {hours.map((h, i) => (
                    ...
                    >
                      <span
                        className={`font-black text-sm ${h.closed ? "text-red-500" : "text-slate-700"}`}
                      >
                        {h.day}
                      </span>
                      <span
                        className={`text-sm font-bold ${h.closed ? "text-red-400" : "text-slate-500"}`}
                      >
                        {h.time}
                      </span>
                    </div>
              ...
              <div className="bg-blue-600 p-10 rounded-[40px] text-white relative overflow-hidden">
                ...
                <div className="relative z-10">
                  ...
                  <p className="text-blue-100 text-sm mb-8 leading-relaxed">
                    Login ke portal peserta untuk mengirimkan tiket bantuan atau
                    tanya jawab seputar ujian.
                  </p>
                  <button
      ...
      <section className="py-24 px-6 bg-[#060b18]">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid md:grid-cols-2 gap-5 max-w-5xl mx-auto">
            {[
              {
                q: "Bagaimana cara mendaftar tes?",
                a: "Buat akun di portal, pilih program, lalu selesaikan pembayaran ke kasir atau via transfer.",
              },
              {
                q: "Berapa lama sertifikat berlaku?",
                a: "Sertifikat EPT berlaku selama 2 tahun sejak tanggal penerbitan.",
              },
              {
                q: "Apakah ada persiapan khusus?",
                a: "Kami menyediakan materi latihan dan panduan yang bisa diakses melalui portal peserta.",
              },
              {
                q: "Kapan hasil tes keluar?",
                a: "Hasil tes biasanya tersedia 3–5 hari kerja setelah ujian selesai dilaksanakan.",
              },
            ].map((faq, i) => (
              <motion.div
                key={i}
          ...
          <div className="grid md:grid-cols-3 gap-16 mb-16">
            <div className="space-y-6">
              <div className="flex items-center gap-3">
                ...
                <div>
                  <span className="font-black text-lg uppercase text-slate-900 block leading-tight">
                    Lembaga Bahasa
                  </span>
