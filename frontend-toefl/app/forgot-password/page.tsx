          ...
          {success ? (
            <div className="text-center">
              ...
              <p className="text-sm text-slate-500 mb-6">
                ...
                terdaftar dalam sistem kami, Anda akan menerima tautan pemulihan
                sesaat lagi. Coba periksa folder Spam jika tidak menemukannya.
              </p>
              <Link
                href="/login"
                className="text-sm font-semibold text-blue-600 hover:text-blue-500 flex items-center justify-center gap-2"
              >
            ...
            <form className="space-y-6" onSubmit={handleSubmit}>
              ...
              <div className="text-center mt-4">
                <Link
                  href="/login"
                  className="text-sm font-semibold text-slate-600 hover:text-slate-900 flex items-center justify-center gap-2"
                >
                  <ArrowLeft className="w-4 h-4" />
                  Kembali ke Login
                </Link>
