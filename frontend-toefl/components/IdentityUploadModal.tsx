...
export default function IdentityUploadModal({
  ...
  const handleFileChange = (
    ...
    if (file.size > 5 * 1024 * 1024) {
      setError(
        `Ukuran file ${type === "face" ? "Foto Wajah" : "KTM"} terlalu besar (Max 5MB).`,
      );
      return;
    }
    ...
    try {
      ...
      if (
        ...
        const details = err.response.data.errors
          .map((e: any) => e.message || e.clientName || "Invalid file")
          .join(", ");
        ...
        <div className="bg-blue-600 p-8 text-center relative overflow-hidden">
          ...
          <div className="relative z-10 flex flex-col items-center">
            ...
            <p className="text-blue-100 mt-2 font-medium">
              Harap lengkapi foto wajah asli dan KTM Anda sebelum memulai ujian.
            </p>
          </div>
        </div>
