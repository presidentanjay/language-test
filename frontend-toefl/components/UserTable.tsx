                ...
                <table className="w-full text-sm text-left text-gray-500 display dark:text-gray-400">
                    <thead className="text-xs text-gray-700 uppercase bg-gray-50 dark:bg-gray-700 dark:text-gray-400">
                        <tr>
                            ...
                            <th scope="col" className="px-6 py-3">Program Study</th>
                            <th scope="col" className="px-6 py-3">Account Created</th>
                            <th scope="col" className="px-6 py-3">Actions</th>
                        </tr>
                    </thead>
                    <tbody>
                        {users.map((user, index) => (
                            <tr key={user.id} className="border-b bg-gray-50 dark:bg-gray-800 dark:border-gray-700">
                                ...
                                <td className="px-6 py-4">{user.profile?.program_study || '-'}</td>
                                ...
                                <td className="px-6 py-4">
                                    <div className="flex gap-2">
                                        ...
                                        >
                                            <svg xmlns="http://www.w3.org/2000/svg" className="w-5 h-5 text-white fill-red-700 dark:fill-white" viewBox="0 0 24 24">
                                        ...
                                        >
                                            <svg xmlns="http://www.w3.org/2000/svg" className="w-5 h-5 text-white fill-blue-700 dark:fill-blue-600" viewBox="0 0 24 24">
                ...
                <div className="fixed inset-0 z-50 flex items-center justify-center bg-black bg-opacity-50">
                    <div className="bg-white rounded-lg p-6 dark:bg-gray-700 max-w-sm w-full mx-4">
                        <div className="text-center">
                            ...
                            <h3 className="text-lg font-semibold mb-2 text-gray-900 dark:text-white">Are you sure want to delete this User?</h3>
                            <p className="text-gray-500 mb-6 font-normal">This action is irreversible and will lead to the removal of User Account forever from the system.</p>
                            <div className="flex justify-center gap-2">
                                ...
                                >
                                    {isDeleting === showDeleteModal ? 'Deleting...' : "Yes, I'm sure"}
                                </button>
                                <button
                                    disabled={isDeleting === showDeleteModal}
