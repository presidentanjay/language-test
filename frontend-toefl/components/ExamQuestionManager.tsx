    ...
    <div>
      ...
      {isAddingSection && (
        <form
          ...
          className="p-4 mb-6 border rounded bg-gray-50 dark:bg-gray-700 dark:border-gray-600"
        >
          <div className="mb-3">
            <label className="block mb-1 text-sm font-medium">
              Section Name (e.g., Listening)
            </label>
            <input
              name="section"
              type="text"
      ...
      <div className="space-y-6">
        {exam.sections.map((section: any) => (
          <div
            key={section.id}
            className="border border-gray-200 rounded-lg p-4 dark:border-gray-700 dark:bg-gray-800"
          >
            <div className="flex justify-between items-start mb-4 border-b pb-2 dark:border-gray-700">
              ...
              <div className="flex gap-2">
                <button
                  ...
                  onClick={() => alert("Edit section logic")}
                >
                  Edit
                </button>
                <button
    ...
    <div className="pl-4 border-l-2 border-gray-100 dark:border-gray-700">
      ...
      {isAdding && (
        <form
          ...
          className="mb-4 p-3 bg-gray-50 rounded dark:bg-gray-700"
        >
          <div className="mb-2">
      ...
      <div className="space-y-3">
        {section.questions.map((q: any, idx: number) => (
          <div
            key={q.id}
            className="p-3 bg-white border border-gray-200 rounded shadow-sm dark:bg-gray-900 dark:border-gray-700"
          >
              ...
              <div className="flex-1">
                ...
                <div className="mt-2 grid grid-cols-2 gap-2 text-xs text-gray-600 dark:text-gray-400">
                  {q.answers.map((a: any) => (
                    <div
                      key={a.id}
                      className={`flex items-center gap-1 ${a.is_correct === "yes" ? "text-green-600 font-bold" : ""}`}
                    >
